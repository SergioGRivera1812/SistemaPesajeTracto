...
namespace SistemaCamionero
{
    public partial class ReImpresion : Form
    {
        ...
        private void Imprimir(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Fecha:  " + Fech, font, Brushes.Black, new RectangleF(10, 80, width, 20));
            e.Graphics.DrawString("Hora Entrada:  " + HE, font, Brushes.Black, new RectangleF(170, 80, width, 20));
            ...
            e.Graphics.DrawString("Hora Salida:  " + HS, font, Brushes.Black, new RectangleF(10, 200, width, 20));
            e.Graphics.DrawString("Peso Salida:  " + N +"Kg" , font, Brushes.Black, new RectangleF(10, 220, width, 20));
